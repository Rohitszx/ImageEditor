...
import com.example.alphaeditor.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
        ...
        protected void onActivityResult(int requestCode,int resultCode, @Nullable Intent data){
            ...
            if(requestCode==IMAGE_REQUEST_CODE){
                if(data.getData()!=null){
                    ...
                    dsPhotoEditorIntent.putExtra(DsPhotoEditorConstants.DS_PHOTO_EDITOR_OUTPUT_DIRECTORY, "Alpha Editor");
    ...
    public Uri getImageUri(Bitmap photo){
        ...
        photo.compress(Bitmap.CompressFormat.JPEG,100,arrayOutputStream);
